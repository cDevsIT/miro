            ...
            <form action="{{ route('admin.colors.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control @error('color_code') is-invalid @enderror" id="color_code" name="color_code" value="{{ old('color_code', '#000000') }}" placeholder="#000000" required>

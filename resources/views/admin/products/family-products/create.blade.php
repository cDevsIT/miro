            ...
            <form action="{{ route('admin.family-products.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('dimensions_lwh') is-invalid @enderror" 
                           id="dimensions_lwh" name="dimensions_lwh" value="{{ old('dimensions_lwh') }}" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('dimensions_qh') is-invalid @enderror" 
                           id="dimensions_qh" name="dimensions_qh" value="{{ old('dimensions_qh') }}" >
                    @error('dimensions_qh')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('cut_hole_in_mm') is-invalid @enderror" 
                           id="cut_hole_in_mm" name="cut_hole_in_mm" value="{{ old('cut_hole_in_mm') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('cut_hole_in_diameter') is-invalid @enderror" 
                           id="cut_hole_in_diameter" name="cut_hole_in_diameter" value="{{ old('cut_hole_in_diameter') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('mounting_type') is-invalid @enderror" 
                           id="mounting_type" name="mounting_type" value="{{ old('mounting_type') }}">
                    @error('mounting_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('voltage') is-invalid @enderror" 
                           id="voltage" name="voltage" value="{{ old('voltage') }}">
                    @error('voltage')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>

                <button type="submit" class="btn btn-primary">Create Family Product</button>
            </form>
        </div>
    </div>
</div>

        ...
        <div className={`product-details ${product.model_number}`}>
            ...
            <div className="product-details-grid container-right-offset">
                ...
                <div className="product-images">
                   ...
                   <span className='product-action-container'> <ProductActions/></span>
                ...
                <div className="product-info">
                    ...
                    <h2 className="product-model">{product.model_number} <span className='product-action-container-mobile'> <ProductActions/></span></h2>
